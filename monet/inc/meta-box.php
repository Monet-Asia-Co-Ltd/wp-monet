...
function generate_save_layout_meta_data( $post_id ) {
	...
	$sidebar_layout_value = filter_input( INPUT_POST, $sidebar_layout_key, FILTER_SANITIZE_ADD_SLASHES );
	...
	$footer_widget_value = filter_input( INPUT_POST, $footer_widget_key, FILTER_SANITIZE_ADD_SLASHES );
	...
	$page_builder_container_value = filter_input( INPUT_POST, $page_builder_container_key, FILTER_SANITIZE_ADD_SLASHES );
	...
	if ( ! defined( 'GENERATE_DE_VERSION' ) ) {
		...
		$disable_content_title_value = filter_input( INPUT_POST, $disable_content_title_key, FILTER_SANITIZE_ADD_SLASHES );
