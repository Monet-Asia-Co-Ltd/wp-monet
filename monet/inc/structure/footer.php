...
if ( ! function_exists( 'generate_add_footer_info' ) ) {
	...
	function generate_add_footer_info() {
		$copyright = sprintf(
			'<span class="copyright">&copy; %1$s </span> MONET ASIA CO., LTD.',
			date( 'Y' ), // phpcs:ignore
			get_bloginfo( 'name' ),
			esc_url( '' ),
			_x( '', '', '' ),
...
<div class="button-line">
  <a class="button-l" href="https://page.line.me/?accountId=monet.asia">
    <div class="box-contact">
      ...
      <div class="button-right">สอบถามสินค้า</div>
    </div>
  </a>
</div>
<?php endif; ?>
