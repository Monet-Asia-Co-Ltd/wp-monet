...
<div class="h-item01">
<a href="/"><?php
$img_url = get_site_url() . '/wp-content/uploads/admin/logo_monet.svg';
echo '<img src="' . esc_url($img_url) . '" alt="Monet" width="150" height="84" loading="lazy">';
?></a>
</div>
<!-- item01 -->
...
<div class="h-item02">
<span><?php
$brand_count = wp_count_terms('brand', ['parent' => 0]);
echo number_format_i18n($brand_count) . ' แบรนด์';
?></span>
<span><?php
$count = wp_count_posts('product')->publish;
echo number_format_i18n($count) . ' รายการ';
?></span>
<span>สินค้าของเรามีมากกว่าในเว็บไซต์ หาสินค้าไม่เจอ <a class="header-link" href="/358-24/">คลิก</a>เพื่อสอบถาม</span>
...
echo '<img src="' . esc_url($img_url) . '" alt="LINE" width="45" height="45" loading="lazy">';
